...
public class EntoriumSporebombEntity extends AbstractArrow implements ItemSupplier {
	public EntoriumSporebombEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(WildasideModEntities.ENTORIUM_SPOREBOMB.get(), world);
	}

	public EntoriumSporebombEntity(EntityType<? extends EntoriumSporebombEntity> type, Level world) {
		super(type, world);
	}

	public EntoriumSporebombEntity(EntityType<? extends EntoriumSporebombEntity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public EntoriumSporebombEntity(EntityType<? extends EntoriumSporebombEntity> type, LivingEntity entity, Level world) {
	...
	public ItemStack getItem() {
		return new ItemStack(WildasideModItems.ENTORIUM_SPOREBOMB.get());
	}
	...
	public static EntoriumSporebombEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		EntoriumSporebombEntity entityarrow = new EntoriumSporebombEntity(WildasideModEntities.ENTORIUM_SPOREBOMB.get(), entity, world);
