...
public class WildasideModTabs {
	public static final DeferredRegister<CreativeModeTab> REGISTRY = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, WildasideMod.MODID);
	public static final RegistryObject<CreativeModeTab> WILDASIDE_TAB = REGISTRY.register("wildaside_tab",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.wildaside.wildaside_tab")).icon(() -> new ItemStack(WildasideModBlocks.VIBRION_BLOCK.get())).displayItems((parameters, tabData) -> {
