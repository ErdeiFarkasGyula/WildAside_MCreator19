...
public class WildasideModEntities {
	...
	public static final RegistryObject<EntityType<PooferEntity>> POOFER = register("poofer",
			EntityType.Builder.<PooferEntity>of(PooferEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(PooferEntity::new).fireImmune().sized(0.7f, 0.5f));
