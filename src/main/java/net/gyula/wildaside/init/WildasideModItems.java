...
public class WildasideModItems {
	...
	public static final RegistryObject<Item> POOFER_SPAWN_EGG = REGISTRY.register("poofer_spawn_egg", () -> new ForgeSpawnEggItem(WildasideModEntities.POOFER, -925091, -13949950, new Item.Properties().tab(WildasideModTabs.TAB_WILDASIDE_TAB)));
	...
	public static final RegistryObject<Item> STRIPPED_BALD_CYPRESS_LOG = block(WildasideModBlocks.STRIPPED_BALD_CYPRESS_LOG, WildasideModTabs.TAB_WILDASIDE_TAB);
	public static final RegistryObject<Item> STRIPPED_BALD_CYPRESS_WOOD = block(WildasideModBlocks.STRIPPED_BALD_CYPRESS_WOOD, WildasideModTabs.TAB_WILDASIDE_TAB);
	...
	public static final RegistryObject<Item> BALD_CYPRESS_STAIRS = block(WildasideModBlocks.BALD_CYPRESS_STAIRS, WildasideModTabs.TAB_WILDASIDE_TAB);
	public static final RegistryObject<Item> BALD_CYPRESS_SLAB = block(WildasideModBlocks.BALD_CYPRESS_SLAB, WildasideModTabs.TAB_WILDASIDE_TAB);
	public static final RegistryObject<Item> BALD_CYPRESS_FENCE = block(WildasideModBlocks.BALD_CYPRESS_FENCE, WildasideModTabs.TAB_WILDASIDE_TAB);
	public static final RegistryObject<Item> BALD_CYPRESS_FENCE_GATE = block(WildasideModBlocks.BALD_CYPRESS_FENCE_GATE, WildasideModTabs.TAB_WILDASIDE_TAB);
	public static final RegistryObject<Item> BALD_CYPRESS_PRESSURE_PLATE = block(WildasideModBlocks.BALD_CYPRESS_PRESSURE_PLATE, WildasideModTabs.TAB_WILDASIDE_TAB);
	public static final RegistryObject<Item> BALD_CYPRESS_BUTTON = block(WildasideModBlocks.BALD_CYPRESS_BUTTON, WildasideModTabs.TAB_WILDASIDE_TAB);
