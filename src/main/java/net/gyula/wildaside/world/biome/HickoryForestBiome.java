...
public class HickoryForestBiome {
	public static final List<Climate.ParameterPoint> PARAMETER_POINTS = List.of(
			new Climate.ParameterPoint(Climate.Parameter.span(-0.4f, 0.5f), Climate.Parameter.span(-0.4f, 0.5f), Climate.Parameter.span(0.1f, 1f), Climate.Parameter.span(-1f, 0.4f), Climate.Parameter.point(0.0f), Climate.Parameter.span(-1f, 0.5f),
					0),
			new Climate.ParameterPoint(Climate.Parameter.span(-0.4f, 0.5f), Climate.Parameter.span(-0.4f, 0.5f), Climate.Parameter.span(0.1f, 1f), Climate.Parameter.span(-1f, 0.4f), Climate.Parameter.point(1.0f), Climate.Parameter.span(-1f, 0.5f),
					0));
