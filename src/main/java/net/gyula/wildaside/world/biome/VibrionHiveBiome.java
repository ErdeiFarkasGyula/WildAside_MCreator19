...
public class VibrionHiveBiome {
	public static final List<Climate.ParameterPoint> UNDERGROUND_PARAMETER_POINTS = List
			.of(new Climate.ParameterPoint(Climate.Parameter.span(-1f, 0f), Climate.Parameter.span(-1f, 0f), Climate.Parameter.span(0.3f, 1f), Climate.Parameter.span(0.4f, 1f), Climate.Parameter.span(0.2f, 0.9f), Climate.Parameter.span(-1f, 1f), 0));

	public static Biome createBiome() {
		BiomeSpecialEffects effects = new BiomeSpecialEffects.Builder().fogColor(12638463).waterColor(-6184663).waterFogColor(-6184663).skyColor(7972607).foliageColorOverride(-6184663).grassColorOverride(-6184663)
