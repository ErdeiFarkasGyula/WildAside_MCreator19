...
public class GlowingHickoryForestBiome {
	...
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register("wildaside:grass_glowing_hickory_forest", VegetationFeatures.PATCH_GRASS,
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register("wildaside:flower_glowing_hickory_forest", VegetationFeatures.FLOWER_DEFAULT,
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("wildaside:mushrooms_huge_glowing_hickory_forest", VegetationFeatures.MUSHROOM_ISLAND_VEGETATION, List.of(CountPlacement.of(1), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome())));
