...
public class GlowingHickoryForestBiome {
	public static final List<Climate.ParameterPoint> PARAMETER_POINTS = List.of(
			new Climate.ParameterPoint(Climate.Parameter.span(0.3f, 0.8f), Climate.Parameter.span(0f, 0.6999f), Climate.Parameter.span(0f, 1.3f), Climate.Parameter.span(-0.3f, 1.1f), Climate.Parameter.point(0.0f), Climate.Parameter.span(-0.4f, 1f),
					0),
			new Climate.ParameterPoint(Climate.Parameter.span(0.3f, 0.8f), Climate.Parameter.span(0f, 0.6999f), Climate.Parameter.span(0f, 1.3f), Climate.Parameter.span(-0.3f, 1.1f), Climate.Parameter.point(1.0f), Climate.Parameter.span(-0.4f, 1f),
					0));
	...
	public static Biome createBiome() {
		...
		return new Biome.BiomeBuilder().precipitation(Biome.Precipitation.RAIN).temperature(0.5f).downfall(0.3f).specialEffects(effects).mobSpawnSettings(mobSpawnInfo.build()).generationSettings(biomeGenerationSettings.build()).build();
	}
}
