...
public class SubstiliumTreeGrowerStr60Feature extends Feature<NoneFeatureConfiguration> {
	public static SubstiliumTreeGrowerStr60Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new SubstiliumTreeGrowerStr60Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("wildaside:substilium_tree_grower_str_60", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("wildaside:substilium_tree_grower_str_60", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public SubstiliumTreeGrowerStr60Feature() {
