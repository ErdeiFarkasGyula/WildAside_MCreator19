...
public class RedGlowingHickorySaplingFeature extends RandomPatchFeature {
	public static RedGlowingHickorySaplingFeature FEATURE = null;
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("wildaside:red_glowing_hickory_sapling", FEATURE,
				FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(WildasideModBlocks.RED_GLOWING_HICKORY_SAPLING.get())), List.of(), 3));
	...
	public RedGlowingHickorySaplingFeature() {
