...
public class NaturalSporeblasterStr37Feature extends Feature<NoneFeatureConfiguration> {
	public static NaturalSporeblasterStr37Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new NaturalSporeblasterStr37Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("wildaside:natural_sporeblaster_str_37", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("wildaside:natural_sporeblaster_str_37", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public NaturalSporeblasterStr37Feature() {
