...
public class HangingVibrionVegetationGrowerStr22Feature extends Feature<NoneFeatureConfiguration> {
	public static HangingVibrionVegetationGrowerStr22Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new HangingVibrionVegetationGrowerStr22Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("wildaside:hanging_vibrion_vegetation_grower_str_22", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("wildaside:hanging_vibrion_vegetation_grower_str_22", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public HangingVibrionVegetationGrowerStr22Feature() {
