...
public class SubstiliumTreeGrowerStr13Feature extends Feature<NoneFeatureConfiguration> {
	public static SubstiliumTreeGrowerStr13Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new SubstiliumTreeGrowerStr13Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("wildaside:substilium_tree_grower_str_13", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("wildaside:substilium_tree_grower_str_13", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public SubstiliumTreeGrowerStr13Feature() {
