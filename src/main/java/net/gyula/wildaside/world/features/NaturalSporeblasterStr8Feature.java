...
public class NaturalSporeblasterStr8Feature extends Feature<NoneFeatureConfiguration> {
	public static NaturalSporeblasterStr8Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new NaturalSporeblasterStr8Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("wildaside:natural_sporeblaster_str_8", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("wildaside:natural_sporeblaster_str_8", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public NaturalSporeblasterStr8Feature() {
