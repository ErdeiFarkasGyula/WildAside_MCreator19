...
public class NaturalSporeblasterStr1Feature extends Feature<NoneFeatureConfiguration> {
	public static NaturalSporeblasterStr1Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new NaturalSporeblasterStr1Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("wildaside:natural_sporeblaster_str_1", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("wildaside:natural_sporeblaster_str_1", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public NaturalSporeblasterStr1Feature() {
