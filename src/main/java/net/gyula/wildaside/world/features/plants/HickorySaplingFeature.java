...
public class HickorySaplingFeature extends RandomPatchFeature {
	public static HickorySaplingFeature FEATURE = null;
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("wildaside:hickory_sapling", FEATURE,
				FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(WildasideModBlocks.HICKORY_SAPLING.get())), List.of(), 1));
