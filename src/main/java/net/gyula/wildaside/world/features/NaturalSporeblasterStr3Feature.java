...
public class NaturalSporeblasterStr3Feature extends Feature<NoneFeatureConfiguration> {
	public static NaturalSporeblasterStr3Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new NaturalSporeblasterStr3Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("wildaside:natural_sporeblaster_str_3", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("wildaside:natural_sporeblaster_str_3", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public NaturalSporeblasterStr3Feature() {
